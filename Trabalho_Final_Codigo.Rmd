...
modelo_1 <- lm(HLRatio ~ FatScore + BodyMass + Heterophils + Eosinophils + Monocytes + Basophils + Genero, data = df)
modelo_1
...
```{r}
modelo_2 <- lm(HLRatio ~ FatScore + Lymphocytes + BodyMass + Eosinophils + Monocytes + Basophils + Genero, data = df)  
modelo_2
...
modelo_3 <- lm(HLRatio ~ Heterophils + Eosinophils, data = df)
...
```{r}
modelo_4 <- glm(HLRatio~FatScore + Lymphocytes  + BodyMass + Eosinophils + Monocytes + Basophils, data = df)  
modelo_4
