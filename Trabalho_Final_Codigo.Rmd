...
# Função para substituir os valores NA pela mediana, agrupada pela espécie
...
modelo <- glm(FatScore ~ HLRatio + BodyMass + Heterophils + Eosinophils + Monocytes + Basophils + Genero, data = df)
...
modelo_2 <- glm(formula = FatScore ~ HLRatio + Heterophils + Monocytes + 
    Genero, data = df)
